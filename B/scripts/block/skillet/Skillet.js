...
export class Skillet extends BlockWithEntity {
    ...
    useOnBlock(args) {
        ...
        if (vanillaItemList.includes(itemId) || cookable) {
            const time = cookable ? (cookable.customComponentParameters.params.time ? cookable.customComponentParameters.params.time : 200) : 200;
            if (currentItem == "undefined") {
...
//# sourceMappingURL=Skillet.js.map