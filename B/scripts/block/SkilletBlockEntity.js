...
import { ItemStack, PlayerInteractWithBlockAfterEvent, system, world, } from "@minecraft/server";
...
let SkilletBlockEntity = class SkilletBlockEntity {
    static onDiscard(entity) {
        const item = entity.getDynamicProperty("farmersdelight:item");
        const amount = entity.getDynamicProperty("farmersdelight:amount");
    ...
    static onTick(entity, block) {
        ...
        const itemId = entity.getDynamicProperty("farmersdelight:item") ?? "undefined";
        let totalAmount = entity.getDynamicProperty("farmersdelight:amount") ?? 0;
        let canAddAmount = entity.getDynamicProperty("farmersdelight:canAdd") ?? 64;
    ...
    static onInteract(args) {
        ...
        let currentItem = entity.getDynamicProperty("farmersdelight:item") ?? "undefined";
        let totalAmount = entity.getDynamicProperty("farmersdelight:amount") ?? 0;
        let canAddAmount = entity.getDynamicProperty("farmersdelight:canAdd") ?? 64;
        const cookData = JSON.parse(entity.getDynamicProperty("farmersdelight:cookData") || "{}");
...
], SkilletBlockEntity, "onInteract", null);
SkilletBlockEntity = __decorate([
    attachedBlockEntity({ eventTypes: ["farmersdelight:skillet_tick"] })
], SkilletBlockEntity);
export { SkilletBlockEntity };
