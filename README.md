...
<a href="https://github.com/ShangguanXi/FarmersDelightBedrock/releases">
	<img src="https://img.shields.io/badge/Available%20for-1.21.70%20%7C%201.21.41%20%7C%201.21.30%20%7C%201.21.20%20%7C%201.21%20%7C%201.20.80-red" alt="Supported Versions">
</a>
...
<a href="https://discord.com/invite/DnMw9JNav5">
...
The Farmer's Delight mod on Java edition is under the MIT License. This license allows me to port it to bedrock edition. Here is the license link: [FarmersDelight: A lightweight farming expansion for Minecraft.](https://github.com/vectorwing/FarmersDelight?tab=MIT-1-ov-file#readme)

### Special thanks to Vectorwing for creating this excellent mod!

## Download

You can download the addon in [GitHub releases](https://github.com/ShangguanXi/FarmersDelightBedrock/releases) or [MCPEDL](https://mcpedl.com/farmer-s-delight-bedrock-unofficial)

## Tutorial

When you first use Farmer's Delight, if you are not familiar with the overall process, you can craft a Farmer's Almanac using dirt and grass stems. You can freely browse through it and learn about the unique mechanics in Farmer's Delight.
...
### Special Thanks to the Following Contributors for Their Translation Efforts  
...
If you enjoy this Addon and would like to support its ongoing development, consider sponsoring us! Your support helps us improve features, fix bugs, and keep updates coming. No matter the amount, your support is greatly appreciated!

### Ways to Sponsor

- [Patreon](https://www.patreon.com/Moaswies)
- [AFDIAN](https://afdian.com/a/moaswies)

### A huge thank you to all our supporters! ❤️
